# angular-datatables SystemJS example

> Sample that use angular-datatables using SystemJS

> This example is based on [Angular 2 quickstart](https://github.com/angular/quickstart)
